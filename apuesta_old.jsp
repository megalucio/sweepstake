...
<thead>
	...
	<th scope="col"></th>
	<th scope="col"></th>
	<th scope="col" align="center" width="70">Resultado</th>
	<th scope="col" align="center" width="50">Puntos</th>
</thead>
		<tbody>
 <%
	stmt.execute(sql);
...
%>
			...
			<%if (Integer.parseInt(id)>63) {%>
		<tr class="final">
			<%}else if (Integer.parseInt(id)>60) {%>
		<tr class="semis">
			<%}else if (Integer.parseInt(id)>56) {%>
		<tr class="cuartos">
			<%}else if (Integer.parseInt(id)>48) {%>
		<tr class="octavos">
			<%}else{%>
		<tr>
			<%}%>			
